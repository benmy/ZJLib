...
#define ACTION_SHEET_DELETE_ACTIONS 3000
...
//        _actionButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemAction target:self action:@selector(actionButtonPressed:)];
        ...
        [button setFrame:CGRectMake(0,0,22,27)];
        button.backgroundColor = [UIColor clearColor];
        [button setImage:[UIImage imageNamed:@"class_share"] forState:UIControlStateNormal];
        [button setImage:[UIImage imageNamed:@"class_share_click"] forState:UIControlStateHighlighted];
        UIBarButtonItem *barButton = [[UIBarButtonItem alloc] initWithCustomView:button];
        _actionButton = barButton;
    }
    if (self.displayDeleteButton) {
        //        _actionButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemAction target:self action:@selector(actionButtonPressed:)];
        UIButton *button =[UIButton buttonWithType:UIButtonTypeCustom];
        [button addTarget:self action:@selector(deleteButtonPressed:) forControlEvents:UIControlEventTouchUpInside];
        [button setFrame:CGRectMake(0,0,20,27)];
        button.backgroundColor = [UIColor clearColor];
        [button setImage:[UIImage imageNamed:@"icon_delete_nor"] forState:UIControlStateNormal];
        [button setImage:[UIImage imageNamed:@"icon_delete_click"] forState:UIControlStateHighlighted];
        UIBarButtonItem *barButton = [[UIBarButtonItem alloc] initWithCustomView:button];
        _deleteButton = barButton;
        _actionButton = nil;
    }
...
//        NSString *backButtonTitle = previousViewController.navigationItem.backBarButtonItem ? previousViewController.navigationItem.backBarButtonItem.title : previousViewController.title;
        ...
        // Appearance
        if ([UIBarButtonItem respondsToSelector:@selector(appearance)]) {
            [newBackButton setBackButtonBackgroundImage:[[UIImage imageNamed:@"btn_back_nor"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 22, 0, 0)] forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
//            [newBackButton setBackButtonBackgroundImage:[UIImage imageNamed:@"btn_back_nor"] forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];

//            [newBackButton setBackButtonBackgroundImage:[UIImage imageNamed:@"btn_back_nor"] forState:UIControlStateNormal barMetrics:UIBarMetricsLandscapePhone];
            [newBackButton setBackButtonBackgroundImage:[UIImage imageNamed:@"btn_back_nor_click"] forState:UIControlStateHighlighted barMetrics:UIBarMetricsDefault];
//            [newBackButton setBackButtonBackgroundImage:[[UIImage imageNamed:@"btn_back_nor_click"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 22, 0, 0)] forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
//            [newBackButton setBackButtonBackgroundImage:[UIImage imageNamed:@"btn_back_click"] forState:UIControlStateHighlighted barMetrics:UIBarMetricsLandscapePhone];
...
- (void)openMenu{
    ...
    if ([self numberOfPhotos] > 0 && [photo underlyingImage]) {
        ...
        UIActionSheet* actionSheet = [[UIActionSheet alloc]
                                      initWithTitle:@"确定要删除这张照片吗？"
                                      delegate:self
                                      cancelButtonTitle:@"取消"
                                      destructiveButtonTitle:nil
                                      otherButtonTitles:@"删除", nil];
        actionSheet.tag = ACTION_SHEET_DELETE_ACTIONS;
        //刚才少写了这一句
...
- (void)actionSheet:(UIActionSheet *)actionSheet didDismissWithButtonIndex:(NSInteger)buttonIndex {
    ...
    }else if (actionSheet.tag == ACTION_SHEET_DELETE_ACTIONS) {
        if (buttonIndex != actionSheet.cancelButtonIndex) {
